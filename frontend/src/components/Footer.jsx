        ...
        <footer className="bg-gray-900 text-gray-300">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* About */}
                    <div>
                        <h3 className="text-white font-bold text-lg mb-4">About College</h3>
                        <p className="text-sm text-gray-400 mb-4">
                            Dedicated to excellence in education, research, and innovation.
                            Shaping future leaders and professionals.
                        </p>
                    ...
                    {/* Academics */}
                    <div>
                        <h3 className="text-white font-bold text-lg mb-4">Academics</h3>
                        <ul className="space-y-2 text-sm">
                            <li><a href="#" className="hover:text-white transition-colors">Computer Science</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Electronics & Communication</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Electrical Engineering</a></li>
